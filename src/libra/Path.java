    ...
    implements Iterable<Path.Code>
{
	...
	public final Parser.Token type;

	public final double[] coords;

	public Code(Parser.Token type, double... coords){
	    super();
	    this.type = type;
	    this.coords = coords;
	}
	...
	Double coord0 = null, coord1 = null, coord2 = null, 
		...
		if (null == coord0){
			...
			case H:
			    sx = coord0;
			    coord0 = null;
			    list = Code.Add(list,new Code(Parser.Token.L,sx,sy));
			    break;
			case h:
			    sx += coord0;
			    coord0 = null;
			...
			case M:
			    list = Code.Add(list,new Code(Parser.Token.M,(mx = coord1),(my = coord1)));
			    coord0 = null;
			    coord1 = null;
			    sx = mx;
			    sy = my;
			...
			case L:
			    list = Code.Add(list,new Code(Parser.Token.L,(sx = coord0),(sy = coord1)));
			    coord0 = null;
			    coord1 = null;
			    break;
			case l:
			...
			switch(state){
			case Q:
			    list = Code.Add(list,new Code(Parser.Token.Q,coord0,coord1,
									  (sx = coord2),(sy = coord3)));
			    coord0 = null;
			    coord1 = null;
			    coord2 = null;
			    ...
			    break;
			case q:
			    list = Code.Add(list,new Code(Parser.Token.Q,(sx + coord0),(sy + coord1),
							  (sx += coord2),(sy += coord3)));
			    coord0 = null;
			    coord1 = null;
			    coord2 = null;
			...
			switch(state){
			case C:
			    list = Code.Add(list,new Code(Parser.Token.C,coord0,coord1,
							  coord2,coord3,
							  (sx = coord4),(sy = coord5)));
			    coord0 = null;
			    coord1 = null;
			    ...
			    break;
			case c:
			    list = Code.Add(list,new Code(Parser.Token.C,(sx + coord0),(sy + coord1),
							  (sx + coord2),(sy + coord3),
							  (sx += coord4),(sy += coord5)));
			    coord0 = null;
			    coord1 = null;
		...
		break;
            case M:
		list = Code.Add(list,new Code(Parser.Token.M,(mx = p.getCoordinate()),(my = p.getCoordinate())));
                sx = mx;
                sy = my;
		state = tok;
                break;
		...
		state = tok;
                break;
            case L:
                list = Code.Add(list,new Code(Parser.Token.L,(sx = p.getCoordinate()),(sy = p.getCoordinate())));
		state = tok;
                break;
            case l:
                list = Code.Add(list,new Code(Parser.Token.L,(sx += p.getCoordinate()),(sy += p.getCoordinate())));
		...
		state = tok;
                break;
            case C:
                list = Code.Add(list,new Code(Parser.Token.C,p.getCoordinate(),p.getCoordinate(),
					      p.getCoordinate(),p.getCoordinate(),
					      (sx = p.getCoordinate()),(sy = p.getCoordinate())));
		state = tok;
                break;
            case c:
                list = Code.Add(list,new Code(Parser.Token.C,(sx + p.getCoordinate()),(sy + p.getCoordinate()),
					      (sx + p.getCoordinate()),(sy + p.getCoordinate()),
					      (sx += p.getCoordinate()),(sy += p.getCoordinate())));
		state = tok;
                break;
            ...
            case Q:
                list = Code.Add(list,new Code(Parser.Token.Q,p.getCoordinate(),p.getCoordinate(),
					      (sx = p.getCoordinate()),(sy = p.getCoordinate())));
		state = tok;
                break;
            case q:
                list = Code.Add(list,new Code(Parser.Token.Q,(sx + p.getCoordinate()),(sy + p.getCoordinate()),
					      (sx += p.getCoordinate()),(sy += p.getCoordinate())));
		state = tok;
                break;
            case T:
                   ...
                   Iterator<Parser.Token>
    {
        ...
        public Iterator<Parser.Token> iterator(){
            return this;
        }
    }
